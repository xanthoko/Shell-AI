...
def remove_excess_supply(chargers: Genome, previous_chargers: Genome,
    ...
    for i, (scs, fcs) in chargers.items():
        ...
        diff = available_supply - supplies_used[i]
        ...
        removable_fcs = fcs - previous_chargers[i][1]
        unused_fcs = diff // 400
        ...
        removable_scs = scs - previous_chargers[i][0]
        unused_scs = diff // 200
        ...
        # update genome
        chargers[i] = (scs - removed_scs, fcs - removed_fcs)
    ...
    print(f'{total_removed_fcs} scs removed')
